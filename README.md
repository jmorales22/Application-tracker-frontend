...
Once a user is signed up to use the service, they can review the history of other users job applications and interviews as well as input their own applications and interviews. Not only does this make keeping up with where you have applied easier, it also gives you access to information from others. It is a great way to manage your applications and interviews and keep track of whom to contact with the companies you have interviewed with.  


In our app you can find:
Node.js (back-end)
Express (back-end)
ElephantSQL (back-end)
React (front-end)
styled components (front-end)
Favicon (front-end)
